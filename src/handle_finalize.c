...
// TODO: Venus team to provide an API to list contracts we may be interested in vTokens, Vaults and
// Pools
...
void handle_finalize(void *parameters) {
    ...
    // Fill context underlying and vault ticker/decimals - loaded from contracts-info.txt for
    // vTokens and Vault

    // TODO: started this for vToken, havent done Vaults, testing will reveal more but
    // 'rain-stopped-play'
    ...
    printf_hex_array(
        "Destination Address: ",
        ADDRESS_LENGTH,
        msg->pluginSharedRO->txContent->destination);  // contract address or users address
    printf_hex_array("Context Address Sent: ",
                     ADDRESS_LENGTH,
                     context->contract_address_sent);  // set by handle_provide_parameter
    printf_hex_array("Context Address Received: ",
                     ADDRESS_LENGTH,
    ...
    */
    ...
    switch (context->selectorIndex) {
        // *** Bep20
        case BEP20_APPROVE:
            // TODO check to see differences between tsContent->destination and
            // context->contract_address_sent
            msg->tokenLookup1 = msg->pluginSharedRO->txContent->destination;
            // msg->tokenLookup1 = context->contract_address_sent;
            //  not using spender msg->tokenLookup2 = context->contract_address_received;  //address
            //  spender
            break;
