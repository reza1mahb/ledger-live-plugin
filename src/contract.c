...
// Function: propose(address[] targets,uint256[] values,string[] signatures,bytes[] calldatas,string
// description,uint8 proposalType) MethodID: 0x164a1ab1
...
// Function: swapExactTokensForTokens(uint256 amountIn,uint256 amountOutMin,address[] path,address
// to,uint256 deadline) MethodID: 0x38ed1739
...
// to,uint256 deadline) MethodID: 0x18cbafe5
static const uint32_t SWAP_EXACT_TOKENS_FOR_ETH_SELECTOR = 0x18cbafe5;

// Function: swapTokensForExactTokens(uint256 amountOut,uint256 amountInMax,address[] path,address
// to,uint256 deadline) MethodID: 0x8803dbee
...
// to,uint256 deadline) MethodID: 0x4a25d94a
